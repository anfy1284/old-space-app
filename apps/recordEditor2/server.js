            ...
            layout: [
                ...
                },
                {
                    ...
                    tabs: [
                        ...
                        {
                            id: 'testOrgTable',
                            caption: 'Организации (DB)',
                            layout: [
                                {
                                    type: 'table',
                                    caption: 'Организации (БД)',
                                    // dynamicTable true signals client to construct a DynamicTable bound to a server table
                                    properties: { dynamicTable: true, appName: 'organizations', tableName: 'organizations', visibleRows: 10, editable: true, showToolbar: true, initialSort: [{ field: 'name', order: 'asc' }] }
                                }
                            ]
                        }
                    ]
